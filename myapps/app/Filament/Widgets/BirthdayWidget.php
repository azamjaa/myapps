...
class BirthdayWidget extends Widget
{
    ...
    // Reduce polling - birthdays don't change frequently
    ...
    public function getBirthdayStaff(): Collection
    {
        ...
        // Cache birthday data for 1 hour
        return Cache::remember("birthday_staff_{$currentMonth}", 3600, function () use ($currentMonth) {
